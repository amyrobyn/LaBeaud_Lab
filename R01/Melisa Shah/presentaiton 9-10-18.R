...
plot(effects::Effect(focal.predictors = c("rain_mean_30"), mod = spline.malaria.c, xlevels = list(rain_mean_30 = 16:371)), rug = FALSE, sub="Chulaimbo", main="Precipitation Effect on Malaria Transmission" ,ylab="Probablity of Plasmodium Positive Microscopy", xlab="Cummulative Precipitation (mm) in last 30 days")
plot(effects::Effect(focal.predictors = c("temp_mean_30"), mod = spline.malaria.c, xlevels = list(temp_mean_30 = 22.52:26.45)), rug = FALSE, sub="Chulaimbo",main="Temperature Effect on Malaria Transmission" ,ylab="Probablity of Plasmodium Positive Microscopy", xlab="Average Temperature (C) in last 30 days")
...
malaria_climate_k$poorses
summary(spline.malaria.k_0 <- lm(microA ~ bs(temp_mean_30, df = 3) + bs(rain_mean_30, df = 4) + bs(aic_calculated_age_A, df=3) + net  + gender_aic_A + poorses, data = malaria_climate_k))
summary(spline.malaria.k_1 <- lm(microA ~ bs(temp_mean_30_1, df = 3) + bs(rain_mean_30, df = 4) + bs(aic_calculated_age_A, df=3) + net  + gender_aic_A + poorses, data = malaria_climate_k))
summary(spline.malaria.k_2 <- lm(microA ~ bs(temp_mean_30_2, df = 3) + bs(rain_mean_30, df = 4) + bs(aic_calculated_age_A, df=3) + net  + gender_aic_A + poorses, data = malaria_climate_k))
summary(spline.malaria.k_3 <- lm(microA ~ bs(temp_mean_30_3, df = 3) + bs(rain_mean_30, df = 4) + bs(aic_calculated_age_A, df=3) + net  + gender_aic_A + poorses, data = malaria_climate_k))
summary(spline.malaria.k_4 <- lm(microA ~ bs(temp_mean_30_4, df = 3) + bs(rain_mean_30, df = 4) + bs(aic_calculated_age_A, df=3) + net  + gender_aic_A + poorses, data = malaria_climate_k))

anova(spline.malaria.k)
exp(cbind(OR = coef(spline.malaria.k), confint(spline.malaria.k)))
plot(effects::Effect(focal.predictors = c("rain_mean_30"), mod = spline.malaria.k, xlevels = list(rainfall_sum_30 = 16:371)), rug = FALSE, sub="Kisumu", main="Precipitation Effect on Malaria Transmission" ,ylab="Probablity of Plasmodium Positive Microscopy", xlab="Cummulative Precipitation (mm) in last 30 days")

plot(effects::Effect(focal.predictors = c("temp_mean_30"), mod = spline.malaria.k_0, xlevels = list(temp_mean_30 = 22.52:26.45)), rug = FALSE, sub="Kisumu",main="Temperature Effect on Malaria Transmission" ,ylab="Probablity of Plasmodium Positive Microscopy", xlab="Average Temperature (C) in last 30 days")
plot(effects::Effect(focal.predictors = c("temp_mean_30_1"), mod = spline.malaria.k_1, xlevels = list(temp_mean_30_1 = 22.52:26.45)), rug = FALSE, sub="Kisumu",main="Temperature Effect on Malaria Transmission (1)" ,ylab="Probablity of Plasmodium Positive Microscopy", xlab="Average Temperature (C) in last 30 days")
plot(effects::Effect(focal.predictors = c("temp_mean_30_2"), mod = spline.malaria.k_2, xlevels = list(temp_mean_30_2 = 22.52:26.45)), rug = FALSE, sub="Kisumu",main="Temperature Effect on Malaria Transmission (2)" ,ylab="Probablity of Plasmodium Positive Microscopy", xlab="Average Temperature (C) in last 30 days")
plot(effects::Effect(focal.predictors = c("temp_mean_30_3"), mod = spline.malaria.k_3, xlevels = list(temp_mean_30_3 = 22.52:26.45)), rug = FALSE, sub="Kisumu",main="Temperature Effect on Malaria Transmission (3)" ,ylab="Probablity of Plasmodium Positive Microscopy", xlab="Average Temperature (C) in last 30 days")
plot(effects::Effect(focal.predictors = c("temp_mean_30_4"), mod = spline.malaria.k_4, xlevels = list(temp_mean_30_4 = 22.52:26.45)), rug = FALSE, sub="Kisumu",main="Temperature Effect on Malaria Transmission (4)" ,ylab="Probablity of Plasmodium Positive Microscopy", xlab="Average Temperature (C) in last 30 days")
