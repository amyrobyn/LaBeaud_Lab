...
use "C:\Users\amykr\Box Sync\Amy Krystosik's Files\ASTMH 2017 abstracts\all linked and cleaned data\data\cleaned_merged_prevalence21 Apr 2017.dta", clear
...
rename acute aic_acute_visit
replace resprate = resp_rate if resprate ==. 
 
keep resprate  aic_acute_visit christian_groups id_wide city cohort visit hoh_tribe  hoh_language parasite_count* hemoglobin  tribeother parasitelevel_desc tribe  parasite_count_all  symptms othersymptms fvrsymptms otherfvrsymptms visit age gender studyid malariapositive_dum* severemalaria cohort chikvpcrresults_dum denvpcrresults_dum stanfordchikvigg_ stanforddenvigg_  species*  parasite_count_lab parasite_count_hcc parasitelevel_desc parasite_count_all all_symptoms_*
order studyid id_wide cohort  visit christian_groups age gender malariapositive_dum2 severemalaria chikvpcrresults_dum denvpcrresults_dum stanfordchikvigg_ stanforddenvigg_  species  parasite_count_lab parasite_count_hcc parasitelevel_desc parasite_count_all resprate  all_symptoms_*
