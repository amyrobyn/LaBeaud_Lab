 ...
 **************************************************************/ 
capture log close 
cd "C:\Users\amykr\Box Sync\Amy Krystosik's Files\vector\"
cd "C:\Users\amykr\Box Sync\DENV CHIKV project\Vector Data\West\West Latest\xls"

*west
foreach dataset in "HLC  Adult Mosquito Sampling  Data" "Larval Sampling Data" "Ovitrap Sampling Data" "Prokopack Sampling Data" "BioGents-Sentinel Trap Mosquito   Sampling Data" {
	import excel "`dataset'.xls", sheet(sheet1) firstrow clear
	save "`dataset'", replace
}

*coast
cd "C:\Users\amykr\Box Sync\DENV CHIKV project\Vector Data\Coast\Coast Latest"
