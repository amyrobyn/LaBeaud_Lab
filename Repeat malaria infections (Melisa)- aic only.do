...
save temp, replace
	...
	order malariapositive_dum*
		...
		replace repeatmalaria_no = 0 if aposbneg ==1|bposcneg==1|cposdneg==1| dposeneg==1|eposfneg==1|fposgneg==1
