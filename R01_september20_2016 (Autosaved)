...
export excel year mydate_day mydate_month mydate_year site visit antigenused_ mydatesamplecollected_ city study_id Stanford_DENV_IGG Stanford_CHIKV_IGG cohort using "/Users/amykrystosik/Box Sync/DENV CHIKV project/Personalized Datasets/Amy/CSVs September 20/prevalent.xls", firstrow(variables) replace
...
drop if Stanford_DENV_IGG==. & Stanford_CHIKV_IGG==.
export excel year mydate_day mydate_month mydate_year site visit antigenused_ mydatesamplecollected_ city study_id Stanford_DENV_IGG Stanford_CHIKV_IGG cohort using "/Users/amykrystosik/Box Sync/DENV CHIKV project/Personalized Datasets/Amy/CSVs September 20/incident.xls", firstrow(variables) replace
restore
